...
const UserTable: React.FC<UserTableProps> = ({
  role,
  tableCaption = "A list of the Users",
}) => {
  // --- State Management ---
  ...
  const [selectedUserForDelete, setSelectedUserForDelete] = useState<
    number | null
  >(null);
  const [selectedUserForNotify, setSelectedUserForNotify] = useState<
    number | null
  >(null);
    ...
    <div className="h-full w-full !p-8 flex flex-col justify-between items-start border rounded-2xl">
        ...
        <TableBody>
          {users.map((user: UserData) => (
            <TableRow key={user.id}>
              ...
              <TableCell>
                {user?.invoice_status ? user.invoice_status : "N/A"}
              </TableCell>
              <TableCell>
                {user?.remaining_days ? user.remaining_days + " days" : "N/A"}
              </TableCell>
              ...
              <TableCell className="text-right space-x-2">
                ...
                <Button
                  variant="outline"
                  size="sm"
                  onClick={() => openNotifyDialog(user.id)}
                >
          ...
          <DialogContent className="!max-w-[40dvw] max-h-[95vh] overflow-y-auto space-y-4">
            ...
            <div className="bg-white rounded-2xl p-6 space-y-4 border border-gray-100">
              ...
              <div className="grid grid-cols-3 gap-4 text-sm text-gray-700">
                ...
                <div>
                  <p className="font-semibold">Is Favorite:</p>
              ...
              <div className="grid grid-cols-7 items-center">
                ...
                <div className="col-span-4 flex flex-wrap gap-2">
                  {viewingUser.favourite_brands?.length > 0 ? (
                    viewingUser.favourite_brands.map((brand) => (
              ...
              <div className="grid grid-cols-7 items-center">
                ...
                <div className="col-span-4 flex flex-wrap gap-2">
                  {viewingUser.favourite_stores?.length > 0 ? (
                    viewingUser.favourite_stores.map((store) => (
            ...
            <div className="grid grid-cols-7 items-center">
              ...
              <div className="col-span-4 text-center text-xs p-2 bg-primary text-primary-foreground rounded-md">
                {viewingUser.total_reviews} reviews (Avg:{" "}
                {viewingUser.avg_rating.toFixed(1)}⭐)
              </div>
            </div>
            ...
            <DialogFooter className="sm:justify-center mt-4">
              ...
              {!viewingUser.is_banned && (
                <Button
                  ...
                  variant={"destructive"}
                  onClick={() =>
                    openBanDialog(viewingUser.id, viewingUser.is_banned)
                  }
                  disabled={isBanning}
                >
              ...
              <Button
                ...
                disabled={isDeleting}
              >
                {isDeleting && selectedUserForDelete === viewingUser.id
                  ? "Deleting..."
                  : "Delete User"}
              </Button>
            </DialogFooter>
        ...
        <AlertDialogContent>
          ...
          <AlertDialogFooter>
            ...
            >
              {isBanning
                ? "Processing..."
                : `Yes, ${selectedUser?.isBanned ? "Unban" : "Ban"}`}
            </Button>
          </AlertDialogFooter>
        </AlertDialogContent>
      </AlertDialog>
      ...
      <Dialog open={suspendDialogOpen} onOpenChange={setSuspendDialogOpen}>
        <DialogContent>
          ...
          <div className="py-4 space-y-4">
            <div>
              <Label htmlFor="suspension-days" className="text-right">
                Days
              </Label>
              <Input
                id="suspension-days"
            ...
            <div>
              <Label htmlFor="suspension-reason" className="text-right">
