        ...
        <AnimatePresence>
          {searchFocus && (
            <motion.div
              ...
              className="absolute top-[calc(148px/3)] lg:-left-[10dvw] 2xl:left-0 sm:w-[80dvw] 2xl:w-full bg-background border shadow-lg max-h-[70dvh] lg:h-[40vh] rounded-lg grid grid-rows-1 2xl:grid-cols-4 z-50  p-4!"
            >
