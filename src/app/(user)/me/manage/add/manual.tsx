...
import { Textarea } from "@/components/ui/textarea"; // This can be removed if not used elsewhere
import { toast } from "sonner";
import { useGetallCategorysQuery } from "@/redux/features/Home/HomePageApi";
import { usePostProductMutation } from "@/redux/features/manage/product";
import { useUser } from "@/context/userContext";
...
// --- DYNAMICALLY IMPORT JODIT EDITOR (NEW) ---
// This prevents Server-Side Rendering (SSR) issues since the editor relies on the 'window' object.
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="col-span-3">
                  <FormLabel>THC Percentage (optional)</FormLabel>
                  <FormControl>
                    <Input placeholder="Enter Ammount " type="number" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
