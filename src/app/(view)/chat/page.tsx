...
//     // Set first user from chatlist as selected by default (only when not searching)
//     useEffect(() => {
//         if (!isSearchActive && chatlistData?.chat_list?.length > 0 && !selectedUser) {
