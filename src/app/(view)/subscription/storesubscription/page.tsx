...
import { useGetstoreAdonsQuery, useGetSubscriptionDetailsQuery, useSendSubscriptionToAdminMutation } from '@/redux/features/store/SubscriptionApi';
...
const StoreSubscriptionPage: NextPage = () => {
    ...
    const onRegisterClick = useCallback(async () => {
        ...
        const plan_ids = [subscription.id, ...Object.keys(selectedAddons).filter(id => selectedAddons[id])];
    ...
    if (!subscription) {
        return (
            <div className="min-h-screen w-full flex items-center justify-center bg-white">
                <p className="text-lg font-semibold text-red-500">Could not load subscription plan.</p>
            </div>
        );
    }
                    ...
                    <section className="w-full max-w-6xl rounded-lg bg-white border-2 border-solid border-blue-600 p-6 md:p-8 relative">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8">
                            ...
                            <div className="flex flex-col">
                                ...
                                <div className="mt-4 text-4xl md:text-6xl font-semibold text-black">${parseFloat(subscription.price).toFixed(0)}/month</div>
                            ...
                            <div className="flex flex-col border-t lg:border-t-0 lg:border-l border-gray-200 pt-8 lg:pt-0 lg:pl-8">
                                ...
                                <ul className="mt-4 space-y-4 text-sm">
                                    ...
                                    {subscription.features && subscription.features.length > 0 ? (
                                        ...
                                        <p className="text-zinc-500">No features listed for this plan.</p>
                                    )}
                                </ul>
                            </div>
                        </div>
