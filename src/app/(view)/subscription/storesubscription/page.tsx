...
const StoreSubscriptionPage: NextPage = () => {
    ...
    const onRegisterClick = useCallback(() => {
        router.push("/subscription/subscription_payment?planid=1");
        ...
        <div className="min-h-screen w-full bg-white text-left text-black font-sans">
            <div className="container mx-auto px-4 py-8 md:py-16">
                ...
                <header className="w-full max-w-2xl mx-auto flex flex-col items-center justify-center p-6 text-center mb-12">
                    <h1 className="font-semibold text-3xl md:text-4xl text-zinc-900">Register - Store</h1>
                    <p className="mt-2 text-base font-medium text-zinc-500">(No Contract, Cancel Anytime)</p>
                </header>

                {/* Main Content: Membership Cards */}
                <main className="flex flex-col items-center gap-12">

                    {/* Verified Business Listing Card */}
                    <section className="w-full max-w-6xl rounded-lg bg-white border-2 border-solid border-blue-600 p-6 md:p-8 relative">
                        <div className="absolute -top-4 left-1/2 -translate-x-1/2 bg-blue-600 text-white text-xs font-bold px-3 py-1 rounded-full">BUSINESS PLAN</div>
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8">
                            {/* Left Side */}
                            <div className="flex flex-col">
                                <b className="text-lg text-blue-600">Your Verified Business Listing</b>
                                <p className="mt-2 text-base text-zinc-500">
                                    Your subscription includes our full suite of tools designed to grow your business and connect with the community.
                                </p>
                                <div className="mt-4 text-4xl md:text-6xl font-semibold text-black">$30/month</div>
                            ...
                            <div className="flex flex-col border-t lg:border-t-0 lg:border-l border-gray-200 pt-8 lg:pt-0 lg:pl-8">
                                ...
                                <ul className="mt-4 space-y-4 text-sm">
                                    <li className="flex items-start gap-3">
                                        <CheckIcon />
                                        <span className="flex-1"><b>Digital Storefront:</b> Your dedicated hub for customer engagement, complete with your product listings, store hours, updates, and reviews.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckIcon />
                                        <div className="flex-1">
                                            <b>Online Order Requests:</b> A built-in "Request, Pay, Pickup" system that allows customers to request items directly from you.
                                            <p className="text-xs italic mt-1">Note: No payments are processed on the platform. All transactions occur through external gateways or in-store.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3"><CheckIcon /><span className="flex-1"><b>Real-Time Customer Insights:</b> Get visibility on trending products and see what your local customers are engaging with.</span></li>
                                    <li className="flex items-start gap-3"><CheckIcon /><span className="flex-1"><b>Bypass Social Media Restrictions:</b> A dedicated, industry-compliant platform to communicate with your customers without fear of shadowbans or account shutdowns.</span></li>
                                    <li className="flex items-start gap-3"><CheckIcon /><span className="flex-1"><b>Direct Connection to a Growing Community:</b> Tap into a unified funnel of passionate consumers who are actively looking for trusted, local stores.</span></li>
                                    <li className="flex items-start gap-3">
                                        <CheckIcon />
                                        <div className='flex-1'>
                                            <b>B2B Ordering Access:</b> Submit direct order requests to brands listed on Vape Shop Maps.
                                            <p className="text-xs italic mt-1">Note: Payments for B2B orders are handled externally between businesses.</p>
                                        </div>
                                    </li>
                                    <li className="flex items-start gap-3"><CheckIcon /><span className="flex-1"><b>Connected Locations:</b> Add a connected location and never lose an out-of-time customer.</span></li>
                                </ul>
                            </div>
                        </div>
                    </section>
