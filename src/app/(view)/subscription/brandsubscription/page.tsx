...
const BrandSubscriptionPage: NextPage = () => {
  ...
  const {
    ...
    refetch,
  } = useGetSubscriptionDetailsQuery({ type: "brand" });
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8">
              ...
              <div className="flex flex-col">
                ...
                <div className="mt-4 text-4xl md:text-6xl font-semibold text-black">
                  ${parseFloat(plan.price).toFixed(0)}/month
                </div>
                <div className="mt-auto pt-6">
                  <b className="text-base text-zinc-700">
                    Beta Price – No Contracts
                  </b>
                </div>
              </div>
              {/* Right Side */}
                        ...
                        <ul className="mt-3 space-y-3 text-sm">
                          <li className="flex items-start gap-3">
                            ...
                            <span className="flex-1">
                              <b>Full Brand Profile Page:</b> Showcase your
                              story, catalog, media, and connected brands
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <CheckIcon />
                            <span className="flex-1">
                              <b>Product Listings:</b> Organized by category
                              (disposables, e-liquids, hardware, etc.)
                            </span>
                          </li>
                        </ul>
                      </div>
                      <div>
                        ...
                        <ul className="mt-3 space-y-3 text-sm">
                          <li className="flex items-start gap-3">
                            <CheckIcon />
                            <span className="flex-1">
                              <b>Trending Placement Eligibility:</b> Appear in
                              “Most Hearted” sections based on engagement
                            </span>
                          </li>
                          <li className="flex items-start gap-3">
                            <CheckIcon />
                            <span className="flex-1">
                              <b>Featured Product Promotions:</b> Spotlight new
                              drops or events
                            </span>
                          </li>
                        </ul>
