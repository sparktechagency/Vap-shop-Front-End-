...
const Membersubscriptionpackage: NextPage = () => {
    ...
    const onSubscribeClick = useCallback(async () => {
        ...
        console.log('Subscribing with plan IDs:', plan_ids);
    ...
    if (!paidPlan || !freePlan || !hempAddon) {
        return (
            <div className="min-h-screen w-full flex items-center justify-center bg-white">
                <p className="text-lg font-semibold text-red-500">Could not load all membership details.</p>
            </div>
        );
    }
        ...
        <div className="min-h-screen w-full bg-white text-left text-black font-sans">
            <div className="container mx-auto px-4 py-8 md:py-16">
                ...
                <main className="flex flex-col items-center gap-8">
                    ...
                    <section className={`w-full max-w-6xl rounded-lg bg-white p-6 md:p-8 transition-all border-2 ${selectedPlanId === freePlan.id ? 'border-green-600' : 'border-black border-solid'}`}>
                    ...
                    <section className={`w-full max-w-6xl rounded-lg bg-white p-6 md:p-8 relative transition-all border-2 ${isPaidPlanSelected ? 'border-purple-600' : 'border-black border-solid'}`}>
                    ...
                    <section className={`w-full max-w-6xl rounded-lg bg-white p-6 md:p-8 transition-opacity ${isPaidPlanSelected ? 'opacity-100 border-black border' : 'opacity-50 bg-gray-50 border-gray-200 border'}`}>
