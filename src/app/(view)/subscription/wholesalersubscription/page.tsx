...
const WholesalerPage: NextPage = () => {
    ...
    const onRegisterClick = useCallback(() => {
        router.push("/subscription/subscription_payment?planid=3");
                    ...
                    <section className="w-full max-w-6xl rounded-lg bg-white border-2 border-solid border-blue-600 p-6 md:p-8 relative">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-8">
                            ...
                            <div className="flex flex-col">
                                <b className="text-lg text-blue-600">Wholesaler Subscription</b>
                                <p className="mt-2 text-base text-zinc-500">
                                    Built for national and regional wholesalers, Vape Shop Maps empowers your business to connect with verified stores, manufacturers, and brands across the vapor industry.
                                </p>
                            ...
                            <div className="flex flex-col border-t lg:border-t-0 lg:border-l border-gray-200 pt-8 lg:pt-0 lg:pl-8">
                                ...
                                <ul className="mt-4 space-y-4 text-sm">
                                    <li className="flex items-start gap-3">
                                        <CheckIcon />
                                        <span className="flex-1"><b>Wholesale Profile Page:</b> Present your full catalog, minimum order terms, regions served, contact details, and more.</span>
                                    </li>
                                    <li className="flex items-start gap-3">
                                        <CheckIcon />
                                        <div className="flex-1">
                                            <b>B2B Ordering Dashboard:</b>
                                            <ul className="list-disc pl-5 mt-1 space-y-1 text-zinc-600">
                                                <li>Receive direct wholesale order requests from stores and brands</li>
                                                <li>Manage inquiries from interested buyers across the industry</li>
                                                <li>Respond with availability, pricing, or product updates from one place</li>
                                                <li className="italic text-xs">Note: All B2B transactions and payments are conducted through external gateways.</li>
                                            </ul>
                                        </div>
                                    </li>
                                    ...
                                    <li className="flex items-start gap-3"><CheckIcon /><span className="flex-1"><b>Direct Messaging & Engagement:</b> Streamline B2B interactions.</span></li>
                                </ul>
                            </div>
                        </div>
                    </section>
