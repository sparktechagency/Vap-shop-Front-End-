...
const WholesalerPage: NextPage = () => {
  ...
  const {
    ...
    refetch,
  } = useGetSubscriptionDetailsQuery({ type: "wholesaler" });
  const { data: wholesalerAdons, isLoading: isLoadingAdons } =
    useWholesellerAdonsQuery();
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center bg-white">
        <p className="text-lg font-semibold text-red-500">
          Could not load the Wholesaler plan.
        </p>
      </div>
    );
  }
                    ...
                    <>
                      ...
                      <li className="flex items-start gap-3">
                        ...
                        <span className="flex-1">
                          <b>Wholesale Profile Page:</b> Present your full
                          catalog, minimum order terms, regions served, contact
                          details, and more.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckIcon />
                        <span className="flex-1">
                          <b>B2B Ordering Dashboard:</b> Receive and manage
                          direct wholesale order requests.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckIcon />
                        <span className="flex-1">
                          <b>Product Visibility & Data:</b> Gain critical
                          product trend data.
                        </span>
                      </li>
                      <li className="flex items-start gap-3">
                        <CheckIcon />
                        <span className="flex-1">
                          <b>Market Access:</b> Connect with verified stores and
                          manufacturers.
                        </span>
                      </li>
                    </>
